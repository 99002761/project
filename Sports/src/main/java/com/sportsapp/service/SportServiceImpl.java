...
public class SportServiceImpl implements SportService{
	...
	@Override
	public List<Sports> getBySportGame(String specialityName) throws SportNotFoundException {
		List<Sports> sportList=sportRepository.getByStadiumName(specialityName);
		if( sportList.isEmpty()) {
	...
	@Override
	public Sports findSportById(Integer sportsId) throws SportNotFoundException {
